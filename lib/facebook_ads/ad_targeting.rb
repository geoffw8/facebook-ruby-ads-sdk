module FacebookAds
  ...
  class AdTargeting
    ...
    attr_accessor :genders, :age_min, :age_max, :countries, :user_os, :user_device, :app_install_state, :custom_locations, :income, :publisher_platforms, :facebook_positions, :custom_audiences
