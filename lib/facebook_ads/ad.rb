module FacebookAds
  ...
  class Ad < Base
    FIELDS   = %w[id account_id campaign_id adset_id adlabels bid_amount bid_info bid_type configured_status created_time creative effective_status last_updated_by_app_id name tracking_specs updated_time].freeze
